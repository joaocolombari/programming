...
#define PM_NUM 8
#define PM_ALL_BY_SIZE "mcuboot_pad otp EMPTY_0 settings_storage mcuboot rpmsg_nrf53_sram sram_primary app mcuboot_primary_app mcuboot_secondary mcuboot_primary"
