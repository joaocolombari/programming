...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_CUSTOM_BME281_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CUSTOM_BME280_DRIVER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DRIVER_INIT_PRIORITY, 71);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_CUSTOM_BME280_DRIVER_MODULE, 1);
