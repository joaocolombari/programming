...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_CUSTOM_ADXL345_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHRE_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHRE_LOG_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CUSTOM_ADXL345_DRIVER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DRIVER_INIT_PRIORITY, 71);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_CUSTOM_ADXL345_DRIVER_MODULE, 1);
