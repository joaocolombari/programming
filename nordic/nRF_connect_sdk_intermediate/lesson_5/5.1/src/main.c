...
static int bme_read_reg(uint8_t reg, uint8_t *data, uint8_t size)
{
	...
	Similarly, for the reception, rx_spi_bufs is pointing to the location pointed by data, 
	and the length of this buffer is size. Lastly, rx_spi_buf_set is pointing to rx_spi_bufs 
