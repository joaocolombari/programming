...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DEVICE_APPEARANCE, 2176);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_SMP, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ISO_MAX_CHAN, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BAP_UNICAST_CLIENT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BAP_UNICAST_CLIENT_GROUP_STREAM_COUNT, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BAP_UNICAST_CLIENT_ASE_SNK_COUNT, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BAP_UNICAST_CLIENT_ASE_SRC_COUNT, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SYSTEM_WORKQUEUE_STACK_SIZE, 1200);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LC3_BITRATE_MAX, 96000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MGMT_CTLR_CFG_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MGMT_CTLR_CFG_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_WDT_CTLR, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CTLR_POLL_WORK_Q_PRIO, 6);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MGMT_DFU_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MGMT_DFU_LOG_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BLE_ACL_EXT_ADV_INT_MIN, 0x00A0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BLE_ACL_EXT_ADV_INT_MAX, 0x00F0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EXT_ADV_BUF_MAX, 20);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EXT_ADV_UUID_BUF_MAX, 20);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BLE_ACL_CONN_INTERVAL, 32);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BAP_UNICAST_CONFIGURABLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_AUDIO_PRES_DELAY_SRCH_PREF_MIN, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CODEC_CAP_COUNT_MAX, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_AUDIO_PREFERRED_MIN_PRES_DLY_US, 10000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_AUDIO_PREFERRED_MAX_PRES_DLY_US, 40000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UNICAST_SERVER_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UNICAST_SERVER_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UNICAST_CLIENT_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UNICAST_CLIENT_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_AUDIO_PREF_SAMPLE_RATE_VALUE, 0x05);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_AUDIO_PREF_SAMPLE_RATE_24KHZ, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_REND_VOL_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_REND_VOL_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_REND_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_REND_LOG_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CS47L63_LOG_LEVEL_DEFAULT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODULE_SD_CARD_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODULE_SD_CARD_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODULE_SD_CARD_PLAYBACK_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODULE_SD_CARD_PLAYBACK_LOG_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_VERSION_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_VERSION_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHAN_ASSIGNMENT_LOG_LEVEL_DEFAULT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF5340_AUDIO_COMMON_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF5340_AUDIO_COMMON_LOG_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BAP_UNICAST, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BAP_UNICAST_CLIENT_GROUP_COUNT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BAP_UNICAST_CLIENT_ASE_SNK, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BAP_UNICAST_CLIENT_ASE_SRC, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TASK_WDT_MIN_TIMEOUT, 100);
