...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DEVICE_APPEARANCE, 2369);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BAP_UNICAST_SERVER, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_AUDIO_CODEC_CFG_MAX_METADATA_SIZE, 25);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ASCS_ISO_DISCONNECT_DELAY, 500);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ASCS_ASE_BUF_TIMEOUT, 50);
